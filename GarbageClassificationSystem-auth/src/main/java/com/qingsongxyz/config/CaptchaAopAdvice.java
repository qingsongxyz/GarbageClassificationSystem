...
public class CaptchaAopAdvice {
    ...
    @Pointcut(value = "execution(* com.qingsongxyz.service.impl.AuthServiceImpl.postAccessTokenWithCaptchaResult(..))")
    ...
    public Object aroundAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (ObjectUtil.isNotEmpty(args) && args[0] instanceof CaptchaResult) {
